// "url": "http://10.10.117.159:5188/api/status-pernikahan",
$(document).ready(function() {
    ...
    $("#bt-save").on("click", function() {
        ...
        var url, type, action;
        var data = {
            statusPernikahan: $('#ed_status_pernikahan').val(),
        ...
        if (edit === false) {
            ...
            url = 'http://10.10.117.159:5188/api/status-pernikahan/' + id;
            type = "PUT";
            action = "update";
            data.userUpdated = 1;
        }
    ...
    $('#table').on('click', '.btn-edit', function() {
        ...
        $.ajax({
            ...
            dataType: 'json',
            success: function(res) {
                $('#ed_status_pernikahan').val(res.statusPernikahan);
                if (res.status == 1) {
