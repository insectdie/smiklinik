// "url": "http://10.10.117.159:5188/api/icd10",
$(document).ready(function() {
    ...
    $("#bt-save").on("click", function() {
        ...
        var url, type, action;
        var data = {
            kodeICD: $('#ed_kode_icd').val(),
            icdIndonesia: $('#ed_icd_indo').val(),
            icdEnglish: $('#ed_icd_ing').val(),
        ...
        if (edit === false) {
            ...
            url = 'http://10.10.117.159:5188/api/icd10/' + id;
            type = "PUT";
            action = "update";
            data.userUpdated = 1;
        }
    ...
    $('#table').on('click', '.btn-edit', function() {
        ...
        $.ajax({
            ...
            headers: {
                ...
                dataType: 'json',
            success: function(res) {
                $('#ed_kode_icd').val(res.kodeICD);
                $('#ed_icd_indo').val(res.icdIndonesia);
                $('#ed_icd_ing').val(res.icdEnglish);
                if (res.status == 1) {
