                    ...
                    <div class="card-body">
                      <form>
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-10">
                            <input type="text" class="form-control" id="ed_sub_kelompok_pasien" />
                            <div class="invalid-feedback">Please enter your sub kelompok pasien.</div>
                          </div>
                        </div>
                  ...
                  <div class="card-datatable">
                    <table id="table" class="table" style="width:100%">
                      <thead>
                          <tr>
                              <th>No</th>
                              <th>Sub Kelompok Pasien</th>
                              <th>ID Kelompok Pasien</th>
